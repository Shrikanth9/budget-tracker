          ...
          <Html>
            ...
            <Body style={styles.body}>
              <Container style={styles.container}>
                <Heading style={styles.title as React.CSSProperties}>Monthly Financial Report</Heading>
                ...
                <Text style={styles.footer as React.CSSProperties}>
                  Thank you for using out budget-tracker. Keep tracking your finances for
